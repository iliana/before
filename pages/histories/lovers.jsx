    ...
    <History authors="Ackasi, Link, Slampy, EDVA, Tillman, Staradavid, and Nell">
      <Entry title="Kichiro Guerra Hits for the Cycle" date="Season 3, Day 35" time="2020-08-05T05:01:23Z">
        <p>
          ...
          her worth by becoming the first player to hit for the cycle in a game against the <Link href="flowers">Boston Flowers</Link>, with a{" "}
          ...
          four at-bats. Though she may no longer have Bloodlust, or even be on the Lovers, Kichiro Guerra still
      ...
      <Entry title="Cracking the Crabs" season={7} day={109}>
        <p>
          ...
          way to the playoffs with <Jump redirect="/standings" time="2020-09-18T20:55:00Z">a 55-44 record</Jump>, the Lovers had a hard road ahead of them. They faced off against the
          team they tied with in their division, the <Link href="jazz-hands">Breckenridge Jazz Hands</Link>, in the Wild League Division Series with
          resounding success, but the real test would be facing one of the biggest teams to
          beat in the Wild League Champion Series, the <Link href="crabs">Baltimore Crabs</Link>. With notable pitching from the likes of
          Percival Wheeler, Milo Brown, and Parker Meng, the Lovers would win in a harrowing five-game series, sending
          them to the finals against the <Link href="wild-wings">Mexico City Wild Wings</Link>.
        </p>
        <LineScore id="e4b98dce-a9aa-4934-b5f0-0b2b35e9f8dd" />
      </Entry>
      <Entry title="There’s Really No Excuse for This, Is There?" season={8} day={16}>
        <p>
          The <Link href="firefighters">Chicago Firefighters</Link> and San Francisco Lovers made history when Caleb Alvarado and Sandford Garner both
      ...
      <Entry title="Crowvertime 1" season={9} day={1}>
        <p>
          ...
          become a permanent fixture in Lovers lore and their community. In the top of the 12th, Alexander Horne
          ...
          instead was an impressive and concerning feat of 21 plate appearances among the angry flock. The Lovers
      ...
      <Entry title="Where’d You Come From?" date="Season 10 Election" time="2020-10-18T19:30:00Z">
        <p>
          ...
          league. Something strange was afoot, though: for one brief moment, the <Link href="fridays">Hawaiʻi Fridays</Link> and the San Francisco
          Lovers both had Montgommery Bullock on their roster, the former from winning the People’s Champion Blessing,
          and the latter from the Popular by Association Blessing. Less than a day later, time
          untangled and confusion across the league was averted. The San Francisco Lovers welcomed their newest pitcher Bontgommery Mullock,
          who was absolutely not a clone of any existing player, to the roster.
        </p>
      </Entry>
      <Entry title="Elsewhere Job" date="Season 13, Day 9" time="2021-03-09T00:29:20Z">
        <p>
          ...
          returned to hit as if nothing happened. After drawing a walk from the <Link href="mechanics">Core Mechanics’</Link> bewildered Lizzy Pasta,
      ...
      >
        <p>
          ...
          Gabriel Griffith of the <Link href="fridays">Hawaiʻi Fridays</Link>. As a pitcher, Carpenter made it through his first inning as a Friday,
      ...
      <Entry title="Whoa. We’re Still Playing?" season={16} day={58}>
        <p>
          ...
          “pitching” duel between a fully-chomped Chorby Soul, at this point uncontested in their quest to never win a game they pitch, and the misplaced “trying to pitch with a bat” Cannonball Sports. After looping with the Black
          Hole, the Lovers awarded Chorby with their first win. The riots that erupted that night after over 40 minutes
          of play were heard around the league, with Mills fan EDVA coining the collective chant:
          {/* block quote */}“Woah. We’re still
      ...
      <Entry title="Theo Eats His Ring" season={20} day={104}>
        <p>
          ...
          then, that in the Lovers’ run to their underchampionship, Theo partied twice and then, in a move that to
      ...
      <Entry title="Haven’t We Seen This Before?" season={20} day={115}>
        <p>
          ...
          Despite these difficulties, the league saw a mirror of Postseason 7, only this time the Lovers
          celebrated their loss against the <Link href="wild-wings">Mexico City Wild Wings</Link>, becoming the ILB’s first underchampion.
        </p>
      </Entry>
      <Entry
      ...
      >
        <p>
          ...
          down without a fight. With the risk of Redaction and Incineration in abundance, several Lovers fans
          elected to go on a massive campaign to collect support for four gift shop items. This campaign was successful,
          with large contributions coming from the <Link href="garages">Seattle Garages</Link>, the <Link href="flowers">Boston Flowers</Link>, and the <Link href="georgias">Atlantis Georgias</Link>. In
          this collective effort, the Lovers put the Fireproof Modification, Soul Patches, and the replicas of Uncle
          Plasma and Liquid Friend on their wish list.
        </p>
        <p>
          These gifts would have immediate positive ramifications for the Lovers: formerly-Redacted Kurt
          Crueller’s soul recovered from zero, Liquid Friend IV and Uncle Plasma IV mounted a resounding defense from Consumers and most momentously,
          on <Jump time="2021-06-24T20:06:21Z">Day 76</Jump>, Fireproof Theo King Incinerated an umpire, the first Lover to do so. Lovers fans realized that, had the
      ...
      <Entry title="Crowvertime 2" season={24} day={38}>
        <p>
          ...
          Crowvertime to rival it. This regular-season game against the Philly Pies set the record for the
          longest ILB game in Beta at a whopping 88 minutes, 12 seconds. Lored as a collective
          effort of the bird-loving Lovers and new pitcher Reece Saetang to hold up the end of the world the safest
        ...
        <p>
          ...
          innings. It was a heated duel between a Lovers lineup that was too bad to hit the ball and an Avoidant Pies lineup that could
          not hit the ball. After walking them home twice in the 11th,{" "}
          <Jump time="2021-07-28T05:42:47Z">the Lovers again tied the game</Jump>, 11-11. And that’s how the score sat
          until <Jump time="2021-07-28T06:15:15Z">the 25th inning</Jump>, when the Lovers pitching squad,
          pitching at a group of hitters literally not allowed to swing at the ball, walked in three more runners. This
          game would catapult the Lovers into having the most birds in the league, ending with 1,086 birds at the end of
          this game.
        </p>
