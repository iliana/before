  ...
  return (
    <History authors="grr">
      <Entry title="The Prestige" season={2} day={102}>
        <p>
          Down 2-0 against the <Link href="steaks">Dallas Steaks</Link> in the Good League Division Series, ace pitcher Matteo Prestige initiated the reverse
        ...
        <p>
          ...
          either, letting the Shoe Thieves face the undefeated <Link href="pies">Philly Pies</Link> in the Internet Series.
        </p>
      ...
      <Entry date="Season 3, Day 57" title="Gunther’s First Game" time="2020-08-06T04:07:10Z">
        <p>
          During a game against the <Link href="breath-mints">Breath Mints</Link>, the Shoe Thieves’ best pitcher Matteo Prestige was tragically
          Incinerated, after having an allergic reaction on <Jump time="2020-08-05T22:22:50Z">Day 52</Jump>. To add
          insult to injury, their replacement was 0-star pitcher Gunther O’Brian. O’Brian immediately claimed the title
      ...
      <Entry date="Season 8, Day 44" title="Famous Shoe Thief Eugenia Garbage" time="2020-09-23T11:04:20Z">
        <p>
          The Shoe Thieves’ history was marked by a curse, exclusively Feedbacking Charleston’s best players in
          exchange for much worse replacements. Fate seemed to take a turn when reality flickered and sent Lachlan
          Shelton back to <Link href="moist-talkers">Canada</Link> in exchange for their best batter, Eugenia Garbage. But the curse was quickly
          reinstated when Feedback hit Eugenia <Jump time="2020-09-23T11:19:21Z">a second time in the same game</Jump>;
      ...
      <Entry date="Season 9, Day 116" title="Preventing Ascension" time="2020-10-11T02:22:50Z">
        <p>
          In Season 9, three teams were in the running for Ascension: the <Link href="pies">Philly Pies</Link>, swept by the Thieves to steal their
          top playoff spot on{" "}
          ...
          ; and finally the <Link href="crabs">Baltimore Crabs</Link>, the only team they had never faced. With Nagomi McDaniel{" "}
          <Jump time="2020-10-10T13:12:50Z">recently Unshelled</Jump>, the Thieves tying the series was already a surprise.
          In game 5, down 2 runs at the bottom of the 9th, Stu Trololol hit a clutch, legendary 3-run home run.
        </p>
      ...
      >
        <p>
          Ever since the <Jump election={4}>Season 4 Election</Jump> when they received the Grappling Hook,
          ...
          5.5 to an absurd 8 defense stars by sipping the entire League. Notable victims included beloved <Link href="magic">Magic player</Link>{" "}
      ...
      <Entry date="Season 11, Day 1" title="Esme’s Haunted" time="2020-10-19T16:05:50Z">
        <p>
          ...
          granting them five Blessings. Among these were the infamous Noise-Cancelling Headphones, Traveling Team, and the mysterious Haunted, described only as “Haunt a random player on your Team.” The initial surprise of Esme Ramsey’s
          Haunting was nowhere near the fans’ collective shock when, on their first plate appearance, Ramsey was instead inhabited by none other than Atlas Jonbois, the ghost of a renowned Shoe Thief who survived less than three days
      ...
      <Entry title="Tillman is Called Back to the Void" election={13}>
        <p>
          ...
          limits, including allowing 2 <Jump time="2021-03-16T03:09:20Z">grand</Jump> <Jump time="2021-03-16T03:11:44Z">slams</Jump> in a single inning.
        </p>
      </Entry>
      <Entry title="The Sneakers Alliance" election={14}>
        <p>
          ...
          of partners in crime the <Link href="spies">Houston Spies</Link>, Shoe Thieves fans pulled a state-of-the-art mutually beneficial
          Exchange with notoriously bad pitcher Jordan Hildebert, finally taking a bat. Combined with a Blood
          Hamburger&ndash;Simba Davis Foreshadow and Herring Winfield Infusion, the Thieves managed to pull off a powerful set
      ...
      <Entry title="A Blood and Bon Voyage!" election={18}>
        <p>
          ...
          turned out to be incredibly fitting. Stew Briggs immediately Roamed away, triggering four parties, and <Jump redirect="/team/bfd38797-8404-4b38-8b82-341da28b1f83" time="2021-05-17T15:02:47Z">A Blood’s
          effect</Jump> tied perfectly with the team’s historical themes of Blood Thieves and their major arcana, the Wheel of
          Fortune.
        </p>
      </Entry>
      <Entry date="Season 21, Day 17" title="Richardson Games Steals the Fifth Base" time="2021-06-22T07:06:20Z">
        <p>
          ...
          , Jesús Koch placed the Fifth Base in the Oven. For almost a season, it sat there, forcing the <Link href="pies">Philly Pies</Link> to
          play five-base Blaseball every home game. Richardson Games was the first player to try picking it up by
          stealing to the Fifth Base, becoming Super Roamin’ in the process, to the horror of Thieves fans who had{" "}
      ...
      <Entry date="Season 23, Day 90" title="Gunther’s Death" time="2021-07-23T10:04:50Z">
        <p>
          ...
          throughout the community led them to be <Jump time="2021-07-02T21:04:08Z">named an MVP posthumously</Jump>, joining the{" "}
      ...
      <Entry date="Season 23, Day 103" title="Richardson Games With the Steel Chair" time="2021-07-24T00:04:40Z">
        <p>
          ...
          off their moves, by defending the <Link href="garages">Seattle Garages</Link> from repeated Consumer attacks attracted by Tot Clark’s
          <Jump redirect="/item/04749f19-e782-40e2-9077-e79baa6236f6" season={23} day={103}>Chorby’s Soul</Jump>. The Charitable Steel Chair broke during the{" "}
