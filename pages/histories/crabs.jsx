    ...
    <History authors="Yurts, Clowne, and Lucien">
      <Entry title="Five Blessings" election={5}>
        <p>
          ...
          were the top voters for five separate Blessings, winning massive stat improvements for many of their
          players and stealing the top pitcher in the league. The one hiccup was the loss of Nagomi McDaniel to the <Link href="jazz-hands">Jazz Hands</Link>, when they won a Blessing that the Crabs were the top voter in.
        </p>
      </Entry>
      <Entry title="The Crabs’ First Championship" season={6} day={110}>
        <p>
          ...
          Crabs dominated both the regular season and postseason, setting the record for most wins in a single
          season by ending the regular season 80-19. The <Link href="pies">Philly Pies</Link> tied that 80-19 record in{" "}
          <Jump time="2021-05-14T20:45:00Z">Season 18</Jump>, though they lost a win due to Black Hole. In the postseason, the Crabs
      ...
      <Entry title="Old Fae Seasoning Buys Night Vision Goggles" election={6}>
        <p>
          ...
          Fae casting 18% of the votes. This was two-thirds of the votes cast by the <Link href="magic">Yellowstone Magic</Link>, who cast 27%. To
      ...
      <Entry title="We Are From Chiclawgo" season={8} day={46}>
        <p>
          Day 46 started a team bonding set of four series against the <Link href="firefighters">Chicago Firefighters</Link>. Crabs and Firefighter fans
          spent nearly a full day in a group watch party on Discord, having fun talking about their lore and players especially
          the brand new Firefighter Goobie Ballson. This cemented a long-running love of the
      ...
      >
        <p>
          Forrest Best was a Season 1 Crab who best personified the Crabs playstyle during the Discipline Era. While
          not a home run monster, Best was incredibly fast, at one point stealing home more than several other teams
          ...
          <Jump time="2021-04-14T19:09:06Z" team="b024e975-1c4a-4575-8936-a3754a08806a">
            make a reappearance
          </Jump> on the <Link href="steaks">Steaks</Link>
      ...
      <Entry title="The Pinch" date="Season 16, Day 16" time="2021-04-13T06:16:27Z">
        <p>
          Shortly after gaining their Evolution, Carcinization, which would steal their opponent’s best
          ...
          test, having two opportunities in Season 16, on Days 16 and{" "}
          <Jump time="2021-04-15T01:21:20Z">56</Jump>, both against the <Link href="moist-talkers">Moist Talkers</Link> and both with star hitter Alston
          Cerveza. Fans had to mobilize a massive amount of votes in minutes, as the chance could come at any moment.
      ...
      <Entry title="Lorcan’s One-Strike Shutout" season={19} day={53}>
        <p>
          ...
          Season 19, Day 53, Lorcan Smaht shut out the <Link href="breath-mints">Breath Mints</Link> with <Jump time="2021-05-19T20:17:01Z">a single strikeout</Jump>, a feat fans found
      ...
      <Entry title="A High Score" season={23} day={24}>
        <p>
          After the Crabs Descended, they landed in Mild Low; games against the <Link href="firefighters">Chicago Firefighters</Link> were less frequent.
        ...
        <p>
          The final game on Day 24 was drawing to a close. The Firefighters, with some assistance from Crabs
          Subtractor Kaz Fiasco, led the score at 8.6-4.9 in the top of the 9th, with Finn James pitching. While she
        ...
        <p>
          ...
          and batting Mora in, scoring another 1.9 runs and bringing the score to
      ...
      <Entry title="float var = 20.3" season={23} day={58}>
        <p>
          Jon Halifax, scammer and nemesis of Crab-kind, had been banished to <Link href="breath-mints">Kansas City</Link> in the{" "}
          <Jump election={22}>previous season’s Election</Jump>. His crimes finally reached their peak on Day 58 when he
          activated the Equal Sun by scoring a home run in the last out of the game, which the Crabs were
          ...
          Crabs, who demanded Halifax’s head.
        </p>
      </Entry>
      <Entry
        title="A Bank Shot"
      ...
      >
        <p>
          ...
          Jon Halifax would once again get away with his crimes&hellip; until Day 63. Helga Washington was Incinerated and the
          ...
          of “and then he died 🦀” from the Crabs and <Link href="breath-mints">Mints</Link>. Both teams honored the sacrifice of Helga Washington for
          hir role in finally bringing Jon to heel. Silvaire Roadhouse, for her part, maintained that the trickshot was
      ...
      <Entry title="Finnstability" season={24} day={14}>
        ...
        <p>
          ...
          40 minutes on the material plane, the Crabs under threat of full-team Incineration with every play. They survived
          their seven Unstable games, but Finn James, as always, kept fans on their toes.
        </p>
      </Entry>
    </History>
  );
