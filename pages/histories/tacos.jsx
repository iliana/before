  ...
  return (
    <History authors="DDDragoni, Deejay, Hen, Cliff, Jellorain, and Dune">
      <Entry date="Season 3, Day 73" title="The Grand Unslam" time="2020-08-06T20:52:54Z">
        <p>
          In the top of the 15th inning, the <Link href="shoe-thieves">Charleston Shoe Thieves</Link> already scored 3 runs, putting them in the lead
          ...
          was pretty much no way&mdash;
        </p>
        <p>
          In the top of the 15th inning, the Charleston Shoe Thieves already scored 3
          runs, putting them in the lead with the bases loaded. Lee Davenport tried to close the inning out, but&mdash;
        </p>
        <p>
          <b>502 BAD GATEWAY</b>
        </p>
        ...
        <p>
          That wasn’t the only change that Election: the Tacos had also won two Blessings: Anticapitalism and Exploratory
        ...
        <p>
          ...
          It also gave the team a unique footprint on the league: with <Jump redirect="/player/c0177f76-67fc-4316-b650-894159dede45" season={24} day={1}>two</Jump>
          <Jump redirect="/player/afc90398-b891-4cdf-9dea-af8a3a79d793" season={24} day={1}>exceptions</Jump>, every player named Wyatt or Mason was once a Taco.
        </p>
      </Entry>
      <Entry season={4} day={99} title="The Chillover">
        <p>
          During an objectively terrible Tacos season, Blaseball experienced its first ever Spillover. The game
          was a grand total of 24 innings and 65 minutes long, breaking two league records to become the longest
        ...
        <p>
          It was a fitting end to a season when the Tacos were trying their hardest to suck and the <Link href="flowers">Boston Flowers</Link> faced
      ...
      <Entry date="Season 7, Day 99" title="The Snackrifice" redirect="/leaderboard" time="2020-09-18T20:55:00Z">
        ...
        <p>
          ...
          blood-hungry Pitching Machine. This devastated the Tacos fanbase. They experienced the
          consequences of their own actions, but not for the last time.
        </p>
      </Entry>
      <Entry
      ...
      <Entry season={11} day={36} title="Taco Tuesday">
        <p>
          In Season 11, the Unlimited Tacos were playing the <Link href="dale">Miami Dale</Link> under Sun 2 weather, with Peanut Bong facing off
        ...
        <p>
          Tacos fans went wild and declared this game “Taco Tuesday,” gaining a longstanding affection for both scoring lots of runs and Sun 2,
          leading to multiple Sun 2-related Blessings and renovations. It also gave Peanut
      ...
      <Entry date="Season 13, Day 99" title="Coin Said Peanut Bong" time="2021-03-12T21:00:18Z">
        <p>
          ...
          from the <Link href="lift">Lift</Link>. This effort, combined with the <Link href="magic">Magic’s</Link> plan to honor Sutton Picklestein after{" "}
      ...
      <Entry season={13} day={111} title="Caleb Alvarado">
        <p>
          The LA Unlimited Tacos never won a playoff game against <Link href="firefighters">Chicago Firefighters</Link> pitcher Caleb Alvarado. They
      ...
      <Entry date="Season 15, Day 74" title="Rat Batson’s Solo Home Run Season" time="2021-04-08T18:04:53Z">
        <p>
          ...
          could do semi-reliably was draw walks. It even had a negative RBI at times, having batted in -0.2 runs as of Day 29 and -1.1 runs as of Day 65, due to Coffee 3s.
        </p>
        <p>
      ...
      >
        <p>
          Exactly two seasons after Nicholas Vincent’s death, Yummy Elliott took the mound to face the <Link href="lift">Tokyo Lift</Link>, with
      ...
      <Entry season={17} day={114} title="The Tacos Win">
        <p>
          ...
          were swept both times, by the <Link href="crabs">Crabs</Link> in Season 13 and the <Link href="moist-talkers">Moist Talkers</Link> in Season 14. After early playoff
          ...
          the Return of Blaseball, and still marked by the Wyatt Masoning. Yummy Elliot led the rotation, the Season
        ...
        <p>
          ...
          in three games, and faced off against the <Link href="fridays">Hawaiʻi Fridays</Link> in the Internet Series, with two former Tacos on their
          roster, Baldwin Breadwinner and Valentine Games. The Tacos won the first two games handily, but the third was
          a close contest, coming down to a tie in <Jump time="2021-04-24T22:23:53Z">the bottom of the 9th</Jump>, at 1-1, with 1 out, Basilio Mason at bat, and Sexton Wheerer on third. This was the perfect setup for a
      ...
      <Entry season={20} day={3} title="Sickos">
        <p>
          In the <Jump election={19}>Season 19 Election</Jump>, the Tacos won the Underhanded Blessing, and the Modification landed on Michelle
      ...
      >
        ...
        <p>
          ...
          <Link href="georgias">Georgias</Link> for Fish Summer, who had themself joined the team in a complicated 3-way trade a few season earlier.
          Ballson was a well-known and popular player, especially with the <Link href="firefighters">Chicago Firefighters</Link>, their original team,
          though there were jokes about them secretly being responsible for several unfortunate events throughout the
          league. With Ballson on the team, fans were excited to be a part of this player’s storied history. Then, on
          Season 22, Day 9, Ballson was Incinerated, barely 24 hours after they joined the team. Amidst the shock and
        ...
        <p>
          Five runs. The Heat Magnet gave five runs. It didn’t even make a difference in the outcome of the game. As fans
