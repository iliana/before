    ...
    <History authors="Spludge237">
      <Entry title="Change Comes For Us All" date="Season 7, Day 107" time="2020-09-19T20:20:36Z">
        ...
        <p>
          ...
          players marked Unstable in a game, with five. On Day 107, a Wing finally proved to be mortal. Rest in
          Violence, Miguel Wheeler. Welcome to the team, Case Sports.
        </p>
      </Entry>
      <Entry title="Add Them to the List" season={7} day={113}>
        <p>
          ...
          Season 7 was about Jaylen Hotdogfingers’ necromancy and, even in the postseason, the Lovers beating the Crabs
          to get to the Internet Series was the biggest story.
        </p>
        <p>
          Yet, on Day 113, the Mexico City Wild Wings won the Internet Series in a game with a tense final inning.
          Stephanie Winters, pitching for the Wings, conceded a run at the top of the 9th to put the Lovers ahead 3-2,
          only to see Summers Preston first drive José Haley home, then capitalize on a Larry Horne single to cross home
          plate herself, shaming the Lovers and winning the championship.
        </p>
      ...
      <Entry title="Goobie Ballson, Murderer" date="Season 8, Day 36" time="2020-09-23T03:05:04Z">
        <p>
          It is hard to pinpoint what started the close friendship between the Wild Wings and the Firefighters. Was it
          Champs in the Making? Was it the Sports-Butt Memorial Series? Or was it Season 8, Day 36 when, in a routine
          game against the Lovers, José Haley was Incinerated, replaced by Goobie Ballson? Wings fans were unsettled;
          Haley was a beloved member of the team, and fans wished them well in Chicago, but it seemed like everyone
          immediately forgot about him in favor of this funnily-named upstart.
        </p>
        <p>
          An in-joke was quickly spawned. What if it wasn’t a Rogue Umpire that Incinerated Haley. What if it was Goobie
      ...
      <Entry title="Case Sports Hits Singles No More" date="Season 12, Day 79" time="2021-03-05T00:10:13Z">
        <p>
          ...
          is, of course, provided that they weren’t representing the New York Millennials in their lawsuit against the
          Coin for the absence of Season 10’s Eat The Rich payout. The trial took place on Discord and was a chaotic
          mess of arguments, violence, and Incinerations but, in the end, justice prevailed. As part of the ruling, it
          was found that Case Sports, in the Wings’ shadows at the time, was too dangerous and/or in too much danger if
          they had time to practice law. They were sent back to the Wings’ lineup, the first time a team’s roster
          changed due to fans outside of an Election.
        </p>
        <p>
          Of course, Blaseball is not safe either and, on Season 12, Day 79, Case Sports was Incinerated. This was the
          first Incineration of the Expansion Era, beating Joshua Butt’s by about 15 minutes, and led to the
          establishment of the Sports-Butt Memorial Series, held every season between the Firefighters and the Wings.
        </p>
      </Entry>
      <Entry title="New Plan: Stop Making Plans" date="Season 12, Day 98" time="2021-03-05T19:09:09Z">
        <p>
          The Coffee Cup proved what the theorist has speculated: Cell Barajas was a very good pitcher, which was a
          shame because she was in the Wings’ lineup. It was clear Barajas had to pitch, but in the pre-Wills era, the
          only way to achieve this was by winning the Best Offense Blessing, swapping the best pitching batter and the
          worst pitcher.
        </p>
        <p>
          ...
          Winters. When the Wings won the Best Offense Blessing, Winters was sent to the lineup instead.
        </p>
      </Entry>
      <Entry title="Burke Gonzales is All You Need" season={13} day={86}>
        ...
        <p>
          ...
          of the 8th, <Jump time="2021-03-12T07:19:37Z">a Rogue Umpire tried to Incinerate Basilio Fig</Jump>, but he
          was a Fire Eater and became Magmatic, guaranteeing a home run during their next at bat.
        </p>
        <p>
          In the top of the 9th, with 2 outs, Gonzalez improbably{" "}
          ...
          hours of the night for most Wings fans, it quickly became the ur-example of the importance of Burke Gonzales,
          tiny pitching god.
        </p>
      ...
      <Entry title="Pspspspspspspspsps" date="Season 15, Day 13" time="2021-04-10T21:14:25Z">
        <p>
          Blaseball is famed for its emergent narratives, the sim telling many stories great and small and almost all
          tremendously tragic. The common interpretation among the Wild Wings is that Stephanie Winters and Summers
          Preston were a couple from the early days of Season 1, if not before. On{" "}
          <Jump time="2021-03-05T05:12:54Z">Season 12, Day 84</Jump>, during the inaugural Sports-Butt Memorial Series,
          Winters was Shelled and the grand tradition of trying to summon the birds began.
        </p>
        <p>
          ...
          made it all the way to the Internet Series against the Canada Moist Talkers. On Day 113, the Birds finally
          heeded fans’ calls, and Winters was freed. The Wings didn’t score another run in the series, and lost. Fans
          celebrated anyway.
        </p>
      </Entry>
      <Entry title="The Wings of Daedalus" date="Season 17, Day 94" time="2021-04-23T14:21:15Z">
        <p>
          It is hard to identify exactly when Greek mythology started to creep into Wings fan discussions. Perhaps being
        ...
        <p>
          ...
          Feedback saw perennial Wild Wings hitter Summers Preston sent to the Dale in exchange for the famed Nagomi
          Mcdaniel. This was followed by a truly catastrophic Reverb on Day 94, during an away game against the Dale,
          that saw Mcdaniel and Joshua Watson sent to the rotation and Barajas and Gonzales brought onto the lineup,
          demolishing both the Wings’ pitching prowess and what little remained of their batting.
        </p>
        <p>
          ...
          injury, the only party of the game was due Worldwide Field’s PsychoAcoustics Echoing the Wings’ Partytime
          Modification, resulting in Preston <Jump time="2021-04-23T14:19:24Z">partying</Jump> and, eventually,{" "}
      ...
      <Entry title="The Star That Burns Twice As Bright" date="Season 18, Day 32" time="2021-05-12T00:07:03Z">
        <p>
          There are some that argue that one of the goals of Blaseball is to be unobserved. Blaseball, they say, has a
          main character, and you desperately don’t want to be it. By and large, the Wings sailed through the seasons
          below the radar of plot relevance, surfacing only to threaten legal action. The Wings batting has always been
          in need of improvement, though, and so a plan was created to Plunder a ringer from another team’s shadows. All
          it would require is a player no-one had ever heard of and getting them onto the Idol Board.
        </p>
        <p>
          With the blessing of the Ohio Worms, Aurora Blortles was targeted, and a large, multi-team cooperative effort
          was undertaken to get Blortles{" "}
      ...
      <Entry title="Too Blaseball to be Cool" season={21} day={5}>
        <p>
          ...
          possible explanation for Season 21, Day 5, when Axel Cardenas pitched a 3-0.2 victory over the Ohio Worms.
        </p>
      ...
      <Entry title="I Was Told That There Wasn’t Going To Be Any Math" season={23} day={13}>
        <p>
          ...
          were not always intuitive or intended. On Day 13, the Boston Flowers visited the Bucket for a game in Jazz
          weather, which riffed immediately into Polarity&nbsp;+. At various points in the game, the score was
          0-&minus;2, 1-&minus;5, 1-&minus;9, 0-&minus;6, &minus;2-&minus;6, &minus;3-&minus;4, before the game ended
          with a final score of &minus;2-0.
        </p>
