    ...
    <History authors="Spludge237">
      <Entry title="Change Comes For Us All" date="Season 7, Day 107" time="2020-09-19T20:20:36Z">
        ...
        <p>
          ...
          defined the season for other teams, Jaylen Hotdogfingers. On Day 105, Jaylen set the record for number of Instabilities caused, beaning five players. On Day 107, a Wing finally proved to be mortal. Rest in
      ...
      <Entry title="Add Them to the List" season={7} day={113}>
        <p>
          ...
          Season 7 was about Jaylen Hotdogfingers’ necromancy and, even in the postseason, the <Link href="lovers">Lovers</Link> beating the <Link href="crabs">Crabs</Link>
          to get to the Internet Series was the biggest story.
        </p>
        <p>
          Yet, on Day 113, the Mexico City Wild Wings won the Internet Series with a tense final inning.
          Stephanie Winters, pitching for the Wings, conceded a run in the top of the 9th to put the Lovers ahead 3-2,
      ...
      <Entry title="Goobie Ballson, Murderer" date="Season 8, Day 36" time="2020-09-23T03:05:04Z">
        <p>
          It is hard to pinpoint what started the close friendship between the Wild Wings and the <Link href="firefighters">Firefighters</Link>. Was it
          Champs in the Making? Was it the Sports-Butt Memorial Series? Or was it Season 8, Day 36 when José Haley was Incinerated in a routine
          game against the Lovers and replaced by Goobie Ballson? Wings fans were unsettled;
      ...
      <Entry title="Case Sports Hits Singles No More" date="Season 12, Day 79" time="2021-03-05T00:10:13Z">
        <p>
          ...
          is, of course, provided that they weren’t representing <Link href="millennials">the New York Millennials</Link> in their lawsuit against the
        ...
        <p>
          Blaseball is not safe either and, on Season 12, Day 79, Case Sports was Incinerated. This was the
          first Incineration of the Expansion Era, beating Joshua Butt’s by about 15 minutes, and led to the
          establishment of the Sports-Butt Memorial Series, held every season between the <Link href="firefighters">Firefighters</Link> and the Wings.
        </p>
      </Entry>
      <Entry title="New Plan: Stop Making Plans" date="Season 12, Day 98" time="2021-03-05T19:09:09Z">
        <p>
          The Coffee Cup proved what Wings fans speculated: Cell Barajas was a very good pitcher, which was a
        ...
        <p>
          ...
          Winters. When the Wings <Jump election={12}>won the Best Offense Blessing</Jump>, Winters was sent to the lineup instead.
        </p>
      </Entry>
      <Entry title="Burke Gonzales is All You Need" season={13} day={86}>
        ...
        <p>
          ...
          hours of the night for most Wings fans, it quickly became the strongest example of the importance of Burke Gonzales,
          tiny pitching god.
        </p>
      ...
      <Entry title="Pspspspspspspspsps" date="Season 15, Day 13" time="2021-04-10T21:14:25Z">
        <p>
          Blaseball is famed for its emergent narratives, with the sim telling many stories great and small and almost all
          tremendously tragic. On{" "}
          <Jump time="2021-03-05T05:12:54Z">Season 12, Day 84</Jump>, during the inaugural Sports-Butt Memorial Series,
          Stephanie Winters was Shelled and the grand tradition of trying to summon the birds began.
        </p>
        <p>
          ...
          made it all the way to the Internet Series against the <Link href="moist-talkers">Canada Moist Talkers</Link>. On Day 113, the Birds finally
      ...
      <Entry title="The Wings of Daedalus" date="Season 17, Day 94" time="2021-04-23T14:21:15Z">
        ...
        <p>
          ...
          Feedback saw perennial Wild Wings hitter Summers Preston sent to the <Link href="dale">Dale</Link> in exchange for the famed Nagomi
        ...
        <p>
          ...
          injury, the only party of the game was due Worldwide Field’s PsychoAcoustics Echoing the Wings’ Life of the Party
      ...
      <Entry title="The Star That Burns Twice As Bright" date="Season 18, Day 32" time="2021-05-12T00:07:03Z">
        <p>
          There are some that argue that one of the goals of Blaseball is to be unobserved. Blaseball always has a
          main character, and fans desperately don’t want their teams to be it. By and large, the Wings sailed through the seasons
          below the radar of plot relevance, surfacing only to threaten legal action. The Wings batting was always in need of improvement, though, and so a plan was created to Plunder a ringer from another team’s shadows. All
          it would require is a player no-one had ever heard of and getting them onto the Idol Board.
        </p>
        <p>
          With the blessing of the <Link href="worms">Ohio Worms</Link>, Aurora Blortles was targeted, and a large, multi-team cooperative effort
      ...
      <Entry title="Too Blaseball to be Cool" season={21} day={5}>
        <p>
          ...
          possible explanation for Season 21, Day 5, when Axel Cardenas pitched a 3-0.2 victory over the <Link href="worms">Ohio Worms</Link>.
        </p>
      ...
      <Entry title="I Was Told That There Wasn’t Going To Be Any Math" season={23} day={13}>
        <p>
          ...
          were not always intuitive or intended. On Day 13, the <Link href="flowers">Boston Flowers</Link> visited the Bucket for a game in Jazz
        ...
        <p>
          Were the game played under the scoring conditions of Season 7, the final score would have been 6-18.
        </p>
      </Entry>
    </History>
  );
