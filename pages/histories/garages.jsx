...
export default function Page({ linescores }) {
  return (
    <History authors={"fionna adams, Riley \"Navi\" Murphy, squirrel, and Leo Mathonwy"}>
      ...
      <Entry date="Season 14 Elections" title="Chorby Soul Reenters the Ring">{/* S14 election results */}
        <p>
