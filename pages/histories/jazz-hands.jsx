...
export default function Page() {
  return (
    <History authors="Sour, King Solomon, deafhobbit, and the Orion System">
      ...
      >
        <p>
          On the precipice of elimination from the Evil League Division Series, the Jazz Hands would see their luck turn
          around when Comfort Septemberish stole home in the bottom of the 9th, opening the door for Aldon Cashmoney to
          deliver a two-run home run death blow to the Tigers. This knocked the Tigers out of contention so hard it got
          into The Blaseball Beat{/* Link to issue when in archive */}. Jazz Hands fans still ask to this day, “Where
          were you when Comfort Septemberish stole home?”
        </p>
      ...
      <Entry title="The First Jazzbeams Double Incineration" season={3} day={23}>
        <p>
          ...
          <Jump time="2020-08-04T17:15:49Z">was Incinerated too</Jump>, the first instance of multiple players
          incinerated in the same game and the first Jazzbeams to die together. This first double Incineration would not
          be the last, however, and would hover over both the Jazz Hands and the Sunbeams for many seasons to come.
        </p>
      </Entry>
      <Entry title="Lowe Tames the Tigers" season={5} day={102}>
        <p>
          The <Link href="tigers">Tigers</Link> were on a hot streak. They had just won back-to-back championships and
          were potentially on track for their third and the Ascension that came with it. The only thing standing in
          their way was Jazz Hands pitcher Lowe Forbes, at the time possessing only a single pitching star. If the Jazz
          Hands lost this game, they’d be up against the Tigers’ best pitchers. Against all odds, Forbes held the Tigers
          to 2 runs, with the Tigers ultimately losing 2-10 and cementing Lowe Forbes as one of the Jazz Hands pitchers
          of all time.
        </p>
      ...
      <Entry title="August Sky vs. PolkaDot Patterson" season={5} day={106}>
        <p>
          August Sky was an ace for the Jazz Hands, but she was up against 5-star pitcher PolkaDot Patterson. Sky and
          the team would go on not only to hold on, but to do so for a then-record 23 innings. Ultimately, the Jazz
          Hands would lose this game, but before they did, the entire league was held hostage by an absurd-for-the-time
          pitchers’ duel.
        </p>
      ...
      >
        <p>
          Postseason 5 was going great for the Jazz Hands. They had tamed the <Link href="tigers">Tigers</Link>, went 23
          innings against PolkaDot Patterson, and now were one win away from their first championship. The score was
          tied up and it looked like the Jazz Hands had a chance to win it all.
        </p>
        <p>
          <Link href="firefighters">Firefighters</Link> batter Declan Suzanne then ate a peanut and had an allergic
          reaction. Suzanne ended up reaching first on a fielder’s choice despite this, pushing Justice Spoon home and
          winning the game for the Firefighters. The Jazz Hands would ultimately lose their first and only Internet
          Series to the Firefighters.
        </p>
      ...
      <Entry title="No Eyes Eleven Hearts Can’t Lose" season={6} day={95}>
        <p>
          ...
          happened if Campos wasn’t Alternated during the <Jump election={4}>Season 4 Election</Jump>, which tripled her
          pitching stars and helped round out the Jazz Hands’ rotation.
        </p>
      ...
      <Entry title="The Burke/Pothos Showdown" season={12} day={66}>
        <p>
          ...
          ridiculous pitchers’ duel that the Jazz Hands and <Link href="wild-wings">Wild Wings</Link> would get caught
          up in as Wyatt Pothos and Burke Gonzales faced off. A 0-0 tie going into extras was fairly predictable, but
      ...
      <Entry title="Combs Estes and the Thursday Blues" season={13} day={98}>
        ...
        <p>
          ...
          “The Thursday Blues” by fans, this unfortunate season taught fans that <Jump election={11}>The Tower</Jump>{" "}
          Always Looms, an important lesson that they would come to fear and embrace.
        </p>
      </Entry>
      <Entry title="Lowe Forbes Good???" season={15} day={79}>
        <p>
          ...
          was the play of a competent batter, one that knew how to hit a ball bat, which was a task Lowe struggled with
          otherwise. Lowe’s surprising plays markedly contributed to that game’s 12-4 win over the{" "}
          <Link href="georgias">Atlantis Georgias</Link>.
        </p>
        <LineScore id="613ef50b-ef18-47d2-acbf-fcd8c6515a7c" />
      </Entry>
      <Entry date="Season 16, Day 14" title="Le Gring" time="2021-04-13T04:11:38Z">
        <p>
          The very first item to ever be granted to a player from Glitter weather was a{" "}
          <Jump redirect="/item/c85b3ae3-b6f5-4a0a-a4ed-67476c02ca6f" time="2021-04-13T04:13:00Z">
            Leg Ring
          </Jump>
          , given to Walton Sports. This, understandably, put the Jazz Hands’ perfectly normal man and team dad into the
          spotlight for a bit. The Leg Ring and it’s rather silly name became an immediate joke with Jazz Hands fans,
          who figured Walton probably thought it was French or something in confusion and called “Le Gring.” The item
          would be associated with Walton for most of the rest of the era, despite dropping it for the Cape of
          Containment in the <Jump election={18}>Season 18 Election</Jump>.
        </p>
      </Entry>
      <Entry title="Hype Builds in The Pocket!" season={19} day={1}>
        ...
        <p>
          ...
          Hype Train started right out of the gate on Day 1 and didn’t stop, even as it drove the team to &minus;55
          Wins.
        </p>
      </Entry>
      <Entry date="Season 21, Day 22" title="The Firewall" time="2021-06-22T12:18:34Z">
        <p>
          ...
          lucky; Silvaire’s first flyout <Jump time="2021-06-22T12:10:07Z">was caught by a Fire Eater</Jump>, but that
          luck was going to run out if someone didn’t do something.
        </p>
        <p>
      ...
      <Entry title="Melonconomy" season={23} day={1}>
        ...
        <p>
          Previously a{" "}
          <Spoiler>
            <Link href="spies">Spy</Link>
          </Spoiler>
          , Jazz Hands fans gave them the moniker “Agent M” while they flew under the league’s radar, seemingly no one
          outside of Breckenridge noticing they had more stars than contemporaries Castillo Turner and Winnie Hess. This
          was the perfect start to the end of the Era of Melon, their final season in the ILB, as well: Disrupt the
          economy, refuse to elaborate, and then leave.
        </p>
      </Entry>
      <Entry title="LCD Soundsystem Fraud" season={23} day={95}>
        <p>
          During the <Jump time="2021-07-22T15:55:00Z">Season 23 Latesiesta</Jump>, Spears Rogers received a{" "}
          <Jump redirect="/item/554aa743-458a-40eb-bc76-4008193b7ca3" season={23} day={95}>
            Fliickerrriiing Greedy Potion of the Famine
          </Jump>{" "}
          from the Gift Shop. During the Feedback game on Day 95,{" "}
          <Jump time="2021-07-23T15:05:24Z">Spears switched places with Famous Owens</Jump>, resulting in the{" "}
          <Link href="tigers">Tigers’</Link> roster becoming entirely Ship of Theseused, losing their last original
          player. The panic of Jazz Hands fans and the despair of the Tigers fans, watching together on Discord, led to
          both teams being allowed to swear without moderation.
        </p>
        <p>
